        ...
        <div className="container mx-auto flex justify-between items-center px-4">
          ...
          <nav
            className={`md:flex space-x-6 ${
              isMobileMenuOpen ? "flex-col mt-4" : "hidden md:flex"
            }`}
          >
          ...
          <div className="flex items-center space-x-4">
            <FontAwesomeIcon
              icon={faUser}
              className="text-[#23a6f0] w-5 h-5 cursor-pointer"
            />
            <button
              onClick={handleLoginClick}
              className="hidden md:flex items-center px-4 py-2 border border-[#23a6f0] text-[#23a6f0] rounded-full hover:bg-[#23a6f0] hover:text-white transition"
            >
              Login / Register
            </button>
            <FontAwesomeIcon
