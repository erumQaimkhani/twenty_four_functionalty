    ...
    <div className="main-container w-full max-w-[1440px] h-auto bg-[#fff] relative overflow-hidden mx-auto my-0 px-4">
      <div className="flex flex-wrap justify-center items-center gap-[30px] relative mt-0 mb-0">
        ...
        <div className="w-full md:w-[573px] flex flex-col gap-[20px] justify-center items-start md:items-start shrink-0 z-[5] text-center md:text-left">
          ...
          <div className="flex gap-[10px] justify-center md:justify-start">
            <Button
              onClick={openModal}
              className="flex w-[160px] md:w-[173px] py-3 px-6 bg-[#2cc070] rounded-[5px] text-[#fff] font-bold text-[14px] hover:shadow-2xl transition-shadow duration-300 ease-in-out"
            >
              BUY NOW
            </Button>
            ...
            <Button
              onClick={openModal}
              className="flex w-[160px] md:w-[173px] py-3 px-6 border border-[#2cc070] rounded-[5px] text-[#2cc070] font-bold text-[14px] hover:shadow-2xl transition-shadow duration-300 ease-in-out"
            >
              READ MORE
            </Button>
          </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-[80%] sm:w-[400px]">
            <h2 className="text-lg font-bold mb-4">Added to Wishlist</h2>
            <p>Your item has been added to your wishlist!</p>
            <div className="mt-4 flex justify-end">
              <Button
                onClick={closeModal}
                className="py-2 px-4 bg-[#2cc070] text-white rounded-md"
              >
                Close
              </Button>
            </div>
